...
include $(CLEAR_VARS)
LOCAL_MODULE       := init.oplus.bsp_debug.sh
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := bin/init.oplus.bsp_debug.sh
LOCAL_MODULE_PATH  := $(TARGET_OUT_ODM)/bin
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := init.oplus.bsp_us_dump.sh
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := bin/init.oplus.bsp_us_dump.sh
LOCAL_MODULE_PATH  := $(TARGET_OUT_ODM)/bin
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := init.oplus.btChangePermission.sh
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := bin/init.oplus.btChangePermission.sh
LOCAL_MODULE_PATH  := $(TARGET_OUT_ODM)/bin
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := bin/init.oplus.fingerprints.sh
LOCAL_MODULE_PATH  := $(TARGET_OUT_ODM)/bin
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := init.oplus.wifi.sh
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := bin/init.oplus.wifi.sh
LOCAL_MODULE_PATH  := $(TARGET_OUT_ODM)/bin
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_PATH  := $(TARGET_OUT_ODM)/etc/init/hw
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE       := init.oplus.wifi.rc
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/init.oplus.wifi.rc
LOCAL_MODULE_PATH  := $(TARGET_OUT_ODM)/etc/init/hw
include $(BUILD_PREBUILT)
